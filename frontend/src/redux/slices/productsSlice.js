...
//Async thunk to fetch products by collection and optonal filters
...
// async thunk to fetch a single product using ID
...
//async thunk to fetch similar procuts
...
const productSlice = createSlice({
    ...
    initialState:{
        products:[],
        selectedProduct:null, //stoer the details of the single product
        similarProducts:[],
        loading:false,
        error:null,
        filters:{
    ...
    extraReducers:(builder)=>{
        builder
        //handel fetching products with filters
