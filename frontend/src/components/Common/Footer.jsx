...
const Footer = () => {
  return (
    <footer className='border-t py-12'>
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 hap-8 px-4 lg:px-0">
            <div className="">
                 ...
                 */}
                 <form action="" className='flex'>
                    <input type="email" placeholder='enter your email' className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring2 focus:ring-gray-500 transition-all' />
            ...
            <div className="">
                ...
                <ul className='space-y-2 text-gray-600'>
                    ...
                    <li>
                        <Link to="#" className='hover:text-gray-500 transition-colors'>Woemen's Bottom Wear</Link>
                    </li>
                </ul>
            </div>
            {/* supporting links  */}
