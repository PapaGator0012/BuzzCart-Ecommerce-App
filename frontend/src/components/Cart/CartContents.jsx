...
const CartContents = ({cart,userId,guestId}) => {
  ...
  //handel add or subtract to cart
                ...
                <div className="flex items-start">
                    ...
                    <div className="">
                        ...
                        <div className="flex item-center mt-2">
                            <button className='border rounded px-2 py-1 text-xl font-medium' onClick={()=>handelAddToCart(product.productId,-1,product.quantity,product.size,product.color)}>-</button>
