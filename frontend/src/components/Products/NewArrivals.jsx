...
if(container){
    ...
    const rightScrollable = container.scrollWidth-1 > leftScroll + container.clientWidth;
  ...
  return (
   <section className='py-16 px-4 lg:px-0'>
    <div className="container mx-auto text-center mb-10 relative">
        ...
        <p className="text-lg text-gray-600 mb-8">Discover the latest styles straight off the runwat , freshly added to keep your wardrobe on the cutting edge of fashion</p>
    ...
    {/* Scroable contnet  */}
    <div ref={scrollRef} className={`container mx-auto overflow-x-scroll flex space-x-6 relative ${isDragging ? "cursor-grabbing":"cursor-grab"}`} onMouseDown={handelMouseDown} onMouseMove={handelMouseMove} onMouseUp={handelMouseUpOrLeave} onMouseLeave={handelMouseUpOrLeave} >
